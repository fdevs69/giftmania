...
(function( $ )
		...
		$('.sticky').ready(function() {
			...
			setTimeout(function() {
				$('#progressBarActivity'+uniqID).fadeIn(function(){
					...
					setTimeout(function() {
						...
						$('.activity-progress-label-1').html('<i class="fa fa-check icon-green"></i>Generated');
					}, 500 );					
				});				
			}, 2000 );
			...
			setTimeout(function() {
				...
				setTimeout(function() {
					...
					$('.activity-progress-label-2').html('<i class="fa fa-check icon-green"></i>Verified');
				}, 500 );
			}, randomNumber );
		});		
	...
	for (var i = 0; i < 4; i++) {
		pierwszaOpcja[i] = $('#pierwszaRzeczPakiety' + i).val();
	}

	var drugaOpcja = [];

	for (var i = 0; i < 4; i++) {
		drugaOpcja[i] = $('#drugaRzeczPakiety' + i).val();
	}
	...
	$.sticky('<div class="recent-activity-tab"><div class="recent-activity-user-wrapper"><img class="r-a-user-icon" src="img/avatar.png"/><span class="activity-username">' + random_username() +'</span></div><div class="activity-generated-amount">'+random_amount() +'</div><div class="recent-activity-progress-wrapper"></div>');
	...
	{
		if ($('#ileDoGenerowania').val() == '1') {
			var Resources = "<span class='recent-activity-r-item-1'>" +random_item(pierwszaOpcja)+ " <span class='recent-activity-r-item-label recent-activity-r-item-1-label'>" +  $('#pierwszaRzeczDop').val() + "</span></span>";	
	 		return Resources;
		}
		else if ($('#ileDoGenerowania').val() == '2') {
			var Resourcesdwa = "<span class='recent-activity-r-item-1'>" +random_item(pierwszaOpcja)+ " <span class='recent-activity-r-item-label recent-activity-r-item-1-label'>" +  $('#pierwszaRzeczDop').val() + "</span></span><span class='recent-activity-r-item-2'>" +random_item(drugaOpcja)+ " <span class='recent-activity-r-item-label recent-activity-r-item-2-label'>" +  $('#drugaRzeczDop').val() + "</span></span>";	
	 		return Resourcesdwa;
		}
	}
}); 
